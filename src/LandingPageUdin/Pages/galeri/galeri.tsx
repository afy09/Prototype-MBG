...
const Gallery = () => {
  const allImages = [
    { src: "/images/galeri1.jpg", category: "Garden" },
    { src: "/images/galeri5.png", category: "Product" },
    { src: "/images/galeri2.png", category: "Garden" },
    { src: "/images/galeri6.png", category: "Product" },
    { src: "/images/galeri3.png", category: "Garden" },
    { src: "/images/galeri7.png", category: "Product" },
    { src: "/images/galeri4.png", category: "Garden" },
    { src: "/images/galeri8.png", category: "Product" },
  ];
  ...
  return (
    <section className="bg-white py-8 px-4 md:px-12">
      <div className="flex gap-5 items-center mb-6">
        ...
        <h1 className="lg:text-[25px] font-semibold text-[18px] text-primary2 w-28">Galeri</h1>
      </div>
      ...
      <div className="flex gap-3 mb-6 flex-wrap justify-center">
        {categories.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg border transition ${selectedCategory === cat ? "bg-primary text-white border-primary" : "bg-white text-primary border-primary hover:bg-primary hover:text-white"}`}>
            {cat}
          </button>
        ))}
      </div>
      ...
      {!showAll && filteredImages.length > 6 && (
        <div className="flex justify-center mt-6">
          <button onClick={() => setShowAll(true)} className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-[#0e3909] transition">
            See More
          </button>
        </div>
      )}
